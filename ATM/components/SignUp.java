...
//       setTitle(pad+"NEW ACCOUNT APPLICATION FORM");
    ...
    {
        JOptionPane.showMessageDialog(null,"Please remember the form number.");
        ...
        try
        {
            ...
            {
                Conn ob = new Conn();
                String sql = "insert into primaryuserdetails values('"+name+"','"+FName+"','"+d+"','"+m+"','"+y+"','"+gender+"','"+email+"','"+mar+"','"+add+"','"+city+"','"+pin+"','"+state+"','"+first+"')";
                ob.stm.executeUpdate(sql);
