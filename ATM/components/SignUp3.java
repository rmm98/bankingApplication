...
//        setTitle(pad+"NEW ACCOUNT APPLICATION FORM - PAGE 3");
        ...
        c7=new JCheckBox("I hereby declare that the above entered details are true to the best of my Knowledge",true);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        long cardno = (ran.nextLong() % 90000000L) + 5040936000000000L;
        cardno = Math.abs(cardno);
        ...
        try
        {
            if(ae.getSource() == b1)
            {
                ...
                {
                    Conn ob = new Conn();
                    String sql1 = "insert into coreuserdetails values('"+accType+"','"+cardno+"','"+pin+"','"+facilities+"','"+formNo+"')";
                    String sql2 = "insert into login values('"+cardno+"','"+pin+"')";
                    String sql3 = "insert into bank values('"+pin+"',null,null,0)";
