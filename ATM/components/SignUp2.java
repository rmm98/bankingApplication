...
//        setTitle(pad+"NEW ACCOUNT APPLICATION FORM - PAGE 2");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        try
        {
            ...
            {
                Conn ob = new Conn();
                String sql = "insert into secondaryuserdetails values('"+religion+"','"+category+"','"+income+"','"+education+"','"+occupation+"','"+pan+"','"+aadhar+"','"+senior+"','"+existing+"','"+formno+"')";
